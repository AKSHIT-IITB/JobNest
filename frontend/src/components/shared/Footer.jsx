...
const Footer = () => {
  return (
    <footer className="bg-[#1E1B4B] text-gray-300 py-8 mt-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold text-white">Job<span className="text-[#A78BFA]">Portal</span></h2>
            <p className="text-sm text-gray-400">© 2024 Your Company. All rights reserved.</p>
          </div>

          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com" className="hover:text-[#A78BFA] transition-colors" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="hover:text-[#A78BFA] transition-colors" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-[#A78BFA] transition-colors" aria-label="LinkedIn">
